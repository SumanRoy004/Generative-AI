...
# installed.
TCL_PREFIX='D:/Generative AI/Generative-AI/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/Generative AI/Generative-AI/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/Generative AI/Generative-AI/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/Generative AI/Generative-AI/venv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/Generative AI/Generative-AI/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/Generative AI/Generative-AI/venv\Library\lib\tclstub86.lib'
